                ...
                <div className="flex flex-col gap-8">
                    <div className='flex w-full flex-col justify-center'>
                        ...
                        <div className='flex flex-row gap-6 md:mx-4'>
                            <div className='flex flex-col items-center md:w-22'>
                                <p className='text-sm md:text-md'>1 DAY </p>
                                <p className='text-lg md:text-xl text-custom-CM-colour'>£ {(prices?.cardmarket[2]?.cardmarket_avg_last_1d)?.toFixed(2)}</p>
                            </div>
                            <div className='flex flex-col items-center md:w-22' >
                                <p className='text-sm md:text-md'>7 DAY</p>
                                <p className='text-lg md:text-xl text-custom-CM-colour'>£ {(prices?.cardmarket[1]?.cardmarket_avg_last_7d)?.toFixed(2)}</p>
                            </div>
                            <div className='flex flex-col items-center md:w-22'>
                                <p className='text-sm md:text-md'>30 DAY</p>
                                <p className='text-lg md:text-xl text-custom-CM-colour'>£ {(prices?.cardmarket[0]?.cardmarket_avg_last_30d)?.toFixed(2)}</p>
                            </div>
                        </div>
                    </div>
                    <div className='flex w-full flex-col justify-center'>
                        ...
                        <div className='flex flex-row gap-6 md:mx-4'>
                            <div className='flex flex-col items-center md:w-22'>
                                <p className='text-sm md:text-md'>1 DAY </p>
                                <p className='text-lg md:text-xl text-custom-TCG-colour'>£ {(prices?.tcgplayer[2]?.tcgplayer_avg_last_1d)?.toFixed(2)}</p>
                            </div>
                            <div className='flex flex-col items-center md:w-22'>
                                <p className='text-sm md:text-md'>7 DAY</p>
                                <p className='text-lg md:text-xl text-custom-TCG-colour'>£ {(prices?.tcgplayer[1]?.tcgplayer_avg_last_7d)?.toFixed(2)}</p>
                            </div>
                            <div className='flex flex-col items-center md:w-22'>
                                <p className='text-sm md:text-md'>30 DAY</p>
                                <p className='text-lg md:text-xl text-custom-TCG-colour'>£ {(prices?.tcgplayer[0]?.tcgplayer_avg_last_30d)?.toFixed(2)}</p>
                            </div>
                        </div>
                    </div>
                </div>
